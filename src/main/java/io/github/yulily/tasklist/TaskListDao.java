...
import io.github.yulily.tasklist.HomeController.TaskItem;
...
public class TaskListDao {
    ...
    // JdbcTemplate は Spring JDBC に用意されてるクラスで、DBを活用する様々な機能を提供
    // @Autowired つけると SprintBoot はコンストラクタを呼び出す際に引数として適切なオブジェクトを作成し渡してくれる
    @Autowired
